...
export default function VoiceTraining() {
  ...
  const handleSaveTemplate = () => {
    ...
    toast.success('Voice template saved successfully.');
  ...
  const handleDeleteTemplate = (templateId: string) => {
    ...
    toast.success('Voice template deleted.');
  };

  const handleRunABTest = () => {
    toast.success('A/B Test Started — testing different voice configurations...');
  };
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <Button onClick={handleRunABTest}>
